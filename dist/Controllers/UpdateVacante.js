...
let EditarVacante = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const vacante = yield VacanteService_1.default.Editar_vacant(new VacanteDto_1.default(nombre_vacante, descripcion_vacante, estado, ubicacion_vacante, categoria_trabajo), new ConsultaDto_1.codDto(cod_vacante));
        console.log(vacante);
